    ...
    return (
        <div className="carousel gap-5 w-full h-[80vh]">
            <div id="slide1" className="carousel-item relative w-full">
                <img src={banner1} className="w-full absolute -z-10 h-full rounded-lg" />
                <div className=' p-6 text-white bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0.00)] h-full flex justify-center flex-col gap-5 w-max rounded-lg'>
                    <h1 className='text-5xl font-bold max-w-md mx-auto text-center md:text-left md:mx-0'>Affordable Price For Car Servicing</h1>
                    <p className='max-w-lg'>There are many variations of passages of  available, but the majority have suffered alteration in some form</p>
            ...
            <div id="slide2" className="carousel-item relative w-full">
                <img src={banner2} className="w-full absolute -z-10 h-full rounded-lg" />
                <div className=' p-6 text-white bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0.00)] h-full flex justify-center flex-col gap-5 w-max rounded-lg'>
                    <h1 className='text-5xl font-bold max-w-md mx-auto text-center md:text-left md:mx-0'>Affordable Price For Car Servicing</h1>
                    <p className='max-w-lg'>There are many variations of passages of  available, but the majority have suffered alteration in some form</p>
                    <div className='space-x-4'>
            ...
            <div id="slide3" className="carousel-item relative w-full">
                <img src={banner3} className="w-full absolute -z-10 h-full rounded-lg" />
                <div className=' p-6 text-white bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0.00)] h-full flex justify-center flex-col gap-5 w-max rounded-lg'>
                    <h1 className='text-5xl font-bold max-w-md mx-auto text-center md:text-left md:mx-0'>Affordable Price For Car Servicing</h1>
                    <p className='max-w-lg'>There are many variations of passages of  available, but the majority have suffered alteration in some form</p>
                    <div className='space-x-4'>
            ...
            <div id="slide4" className="carousel-item relative w-full">
                <img src={banner4} className="w-full absolute -z-10 h-full rounded-lg" />
                <div className=' p-6 text-white bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0.00)] h-full flex justify-center flex-col gap-5 w-max rounded-lg'>
                    <h1 className='text-5xl font-bold max-w-md mx-auto text-center md:text-left md:mx-0'>Affordable Price For Car Servicing</h1>
                    <p className='max-w-lg'>There are many variations of passages of  available, but the majority have suffered alteration in some form</p>
                    <div className='space-x-4'>
            ...
            <div id="slide5" className="carousel-item relative w-full">
                <img src={banner5} className="w-full absolute -z-10 h-full rounded-lg" />
                <div className=' p-6 text-white bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0.00)] h-full flex justify-center flex-col gap-5 w-max rounded-lg'>
                    <h1 className='text-5xl font-bold max-w-md mx-auto text-center md:text-left md:mx-0'>Affordable Price For Car Servicing</h1>
                    <p className='max-w-lg'>There are many variations of passages of  available, but the majority have suffered alteration in some form</p>
                    <div className='space-x-4'>
